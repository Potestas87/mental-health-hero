    ...
    public async void ContinueAs(string selectedClass)
    {
        ...
        try
        {
            ...
            var data = new Dictionary<string, object>
            {
                ...
                { "ownedCosmeticIds", new[] { "tint_default", "tint_crimson" } },
                { "equippedCosmeticIdsByCategory", new Dictionary<string, object> { { CosmeticsCatalog.TintCategoryKey, "tint_default" } } },
                { "equippedTintId", "tint_default" },
